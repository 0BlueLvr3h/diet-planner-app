    ...
    <section className="rounded-3xl border border-slate-200 bg-white p-4 shadow-soft lg:p-5">
      <div className="mb-4 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">Crea modelli stabili, duplicali e modificali al volo.</p>
        </div>
        <div className="flex flex-wrap gap-2">
          <button onClick={addVariant} className="btn-primary">Nuova variante</button>
          <button onClick={duplicateVariant} className="btn-secondary">Duplica variante</button>
          <button
